...
<head>
    ...
    <title>Register | Dinas Arsip dan Perpustakaan - Fuzzy Tsukamoto</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form method="POST" action="Register_Behind.php">
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" name="nama" placeholder="Enter your name" class="form-control input-no-border" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input type="text" name="username" placeholder="Enter username" class="form-control input-no-border" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="email" placeholder="Enter email" class="form-control input-no-border" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" name="password" placeholder="Enter password" class="form-control input-no-border" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Kode Pegawai</label>
                                            <input type="text" name="kode_pegawai" placeholder="Enter employee code" class="form-control input-no-border" required>
                                        </div>
                                    </div>
                                    <div class="card-footer text-center">
                                        <button type="submit" name="registerSubmit" value="register" class="btn btn-fill btn-wd">Register</button>
                                        <a href="index.php" class="btn btn-primary btn-wd">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
