...
<head>
    ...
    <title>Forgot Password | Dinas Arsip dan Perpustakaan - Fuzzy Tsukamoto</title>
                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="email" placeholder="Enter registered email" class="form-control input-no-border" required>
                                        </div>
                                    </div>
                                    <div class="card-footer text-center">
                                        <button type="submit" name="reset_password" class="btn btn-fill btn-wd">Kirim Email Verifikasi</button>
                                        <!-- Link untuk kembali ke halaman login -->
                                        <a href="index.php" class="btn btn-primary btn-wd">Back to Login</a>
                                    </div>
                                </div>
                            </form>
                        </div>
