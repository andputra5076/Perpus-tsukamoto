...
<head>
  ...
  <title>Login | Dinas Arsip dan Perpustakaan - Fuzzy Tsukamoto</title>
  ...
  <nav class="navbar navbar-transparent navbar-absolute">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Dinas Arsip dan Perpustakaan - Prediksi Fuzzy Tsukamoto</a>
      </div>
              ...
              <form method="POST" action="Login_Behind.php">
                <div class="card" data-background="color" data-color="blue">
                  ...
                  <div class="card-footer text-center">
                    <button type="submit" name="IDSubmit" value="login" class="btn btn-fill btn-wd">Login</button>
                    <!-- Button untuk register, mengarahkan ke halaman register.php -->
                    <a href="register.php" class="btn btn-primary btn-wd">Register</a>
                    <!-- Link untuk lupa password, mengarahkan ke halaman forgot_password.php -->
                    
                  </div>
                  <div class="card-footer text-center">
                  <a href="forgot_password.php" class="btn btn-warning btn-wd">Lupa Password</a>
                  </div>
                </div>
              </form>
